...
public class GyroTurn extends CommandBase {
	...
	/**
	 * Instantiate a turn object. Angle is in gyroscope native units.
	 * @param targetAngle
    ...
    public void execute() {
		// Makes the robot turn slower as it gets closer to its goal
		error = (targetHeading - m_subsystem.getGyroYaw()) * DrivetrainMotors.kP_turn;
