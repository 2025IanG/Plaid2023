...
public class PIDGyroTurn extends PIDCommand {
    ...
    public PIDGyroTurn(Drivetrain m_subsystem, double targetAngle) {
        super( 
			new PIDController(DrivetrainMotors.kP_turn, DrivetrainMotors.kI_turn, DrivetrainMotors.kD_turn),
		...
		getController().setTolerance(DrivetrainMotors.kTurnToleranceDeg, DrivetrainMotors.kTurnRateToleranceDegPerS);
    }
